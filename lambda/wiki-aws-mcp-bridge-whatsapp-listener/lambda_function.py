...
EVENT_SOURCE = "lambda.whatsapp.listener"
EVENT_DETAIL_TYPE = "whatsapp.message.received"
...
def lambda_handler(event, context):
    ...
    auth_token = parsed_body.get("webhook-secret-key")
